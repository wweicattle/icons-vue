...
var ElementPlusIconsVue = (() => {
  ...
  var import_vue = __toESM(require_vue()), import_vue2 = __toESM(require_vue()), import_vue3 = __toESM(require_vue()), _hoisted_1 = /* @__PURE__ */ (0, import_vue2.createElementVNode)("path", {
    ...
    _hoisted_1
  ], histogram_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
    __name: "histogram",
    props: {
      size: {
        type: String,
  ...
  return __toCommonJS(histogram_exports);
})();
