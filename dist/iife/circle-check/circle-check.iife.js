...
var ElementPlusIconsVue = (() => {
  ...
  var import_vue = __toESM(require_vue()), import_vue2 = __toESM(require_vue()), import_vue3 = __toESM(require_vue()), _hoisted_1 = /* @__PURE__ */ (0, import_vue2.createElementVNode)("path", {
    ...
    _hoisted_1,
    _hoisted_2
  ], circle_check_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
    __name: "circle-check",
    props: {
      size: {
        type: String,
  ...
  return __toCommonJS(circle_check_exports);
})();
