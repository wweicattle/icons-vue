...
var eleme_filled_exports = {};
__export(eleme_filled_exports, {
  default: () => eleme_filled_default
});
module.exports = __toCommonJS(eleme_filled_exports);
...
var eleme_filled_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "eleme-filled",
  props: {
    size: {
      type: String,
