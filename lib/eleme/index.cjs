...
var eleme_exports = {};
__export(eleme_exports, {
  default: () => eleme_default
});
module.exports = __toCommonJS(eleme_exports);
...
var eleme_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "eleme",
  props: {
    size: {
      type: String,
