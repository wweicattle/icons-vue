...
var chat_line_round_exports = {};
__export(chat_line_round_exports, {
  default: () => chat_line_round_default
});
module.exports = __toCommonJS(chat_line_round_exports);
...
var chat_line_round_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
