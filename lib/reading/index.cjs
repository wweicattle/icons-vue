...
var reading_exports = {};
__export(reading_exports, {
  default: () => reading_default
});
module.exports = __toCommonJS(reading_exports);
...
var reading_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "reading",
  props: {
    size: {
      type: String,
