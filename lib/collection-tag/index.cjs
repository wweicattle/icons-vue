...
var collection_tag_exports = {};
__export(collection_tag_exports, {
  default: () => collection_tag_default
});
module.exports = __toCommonJS(collection_tag_exports);
...
var import_vue = require("vue"), import_vue2 = require("vue"), import_vue3 = require("vue"), _hoisted_1 = /* @__PURE__ */ (0, import_vue2.createElementVNode)("path", {
  ...
  _hoisted_1
], collection_tag_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
