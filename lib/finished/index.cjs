...
__export(finished_exports, {
  default: () => finished_default
});
module.exports = __toCommonJS(finished_exports);
...
var finished_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "finished",
  props: {
    size: {
      type: String,
