...
var d_arrow_left_exports = {};
__export(d_arrow_left_exports, {
  default: () => d_arrow_left_default
});
module.exports = __toCommonJS(d_arrow_left_exports);
...
var d_arrow_left_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "d-arrow-left",
  props: {
    size: {
      type: String,
