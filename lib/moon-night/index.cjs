...
var moon_night_exports = {};
__export(moon_night_exports, {
  default: () => moon_night_default
});
module.exports = __toCommonJS(moon_night_exports);
...
var moon_night_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "moon-night",
  props: {
    size: {
      type: String,
