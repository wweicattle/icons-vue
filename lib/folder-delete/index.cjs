...
var folder_delete_exports = {};
__export(folder_delete_exports, {
  default: () => folder_delete_default
});
module.exports = __toCommonJS(folder_delete_exports);
...
var folder_delete_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
