...
var bell_filled_exports = {};
__export(bell_filled_exports, {
  default: () => bell_filled_default
});
module.exports = __toCommonJS(bell_filled_exports);
...
var bell_filled_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "bell-filled",
  props: {
    size: {
      type: String,
