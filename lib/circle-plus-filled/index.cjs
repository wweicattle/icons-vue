...
var circle_plus_filled_exports = {};
__export(circle_plus_filled_exports, {
  default: () => circle_plus_filled_default
});
module.exports = __toCommonJS(circle_plus_filled_exports);
...
var circle_plus_filled_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
