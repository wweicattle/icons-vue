...
var price_tag_exports = {};
__export(price_tag_exports, {
  default: () => price_tag_default
});
module.exports = __toCommonJS(price_tag_exports);
...
var price_tag_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "price-tag",
  props: {
    size: {
      type: String,
