...
var folder_remove_exports = {};
__export(folder_remove_exports, {
  default: () => folder_remove_default
});
module.exports = __toCommonJS(folder_remove_exports);
...
var folder_remove_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
