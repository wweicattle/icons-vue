...
var quartz_watch_exports = {};
__export(quartz_watch_exports, {
  default: () => quartz_watch_default
});
module.exports = __toCommonJS(quartz_watch_exports);
...
var quartz_watch_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "quartz-watch",
  props: {
    size: {
      type: String,
