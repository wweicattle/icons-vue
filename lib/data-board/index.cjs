...
var data_board_exports = {};
__export(data_board_exports, {
  default: () => data_board_default
});
module.exports = __toCommonJS(data_board_exports);
...
var data_board_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "data-board",
  props: {
    size: {
      type: String,
