...
var warn_triangle_filled_exports = {};
__export(warn_triangle_filled_exports, {
  default: () => warn_triangle_filled_default
});
module.exports = __toCommonJS(warn_triangle_filled_exports);
...
var warn_triangle_filled_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
