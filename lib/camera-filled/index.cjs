...
var camera_filled_exports = {};
__export(camera_filled_exports, {
  default: () => camera_filled_default
});
module.exports = __toCommonJS(camera_filled_exports);
...
var camera_filled_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
