...
var dish_dot_exports = {};
__export(dish_dot_exports, {
  default: () => dish_dot_default
});
module.exports = __toCommonJS(dish_dot_exports);
...
var dish_dot_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "dish-dot",
  props: {
    size: {
      type: String,
