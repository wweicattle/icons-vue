...
var goods_filled_exports = {};
__export(goods_filled_exports, {
  default: () => goods_filled_default
});
module.exports = __toCommonJS(goods_filled_exports);
...
var goods_filled_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "goods-filled",
  props: {
    size: {
      type: String,
