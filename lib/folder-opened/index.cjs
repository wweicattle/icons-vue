...
var folder_opened_exports = {};
__export(folder_opened_exports, {
  default: () => folder_opened_default
});
module.exports = __toCommonJS(folder_opened_exports);
...
var folder_opened_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
