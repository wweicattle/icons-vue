...
var add_location_exports = {};
__export(add_location_exports, {
  default: () => add_location_default
});
module.exports = __toCommonJS(add_location_exports);
...
var add_location_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "add-location",
  props: {
    size: {
      type: String,
