...
var milk_tea_exports = {};
__export(milk_tea_exports, {
  default: () => milk_tea_default
});
module.exports = __toCommonJS(milk_tea_exports);
...
var milk_tea_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "milk-tea",
  props: {
    size: {
      type: String,
