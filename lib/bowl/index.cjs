...
var bowl_exports = {};
__export(bowl_exports, {
  default: () => bowl_default
});
module.exports = __toCommonJS(bowl_exports);
...
var bowl_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  __name: "bowl",
  props: {
    size: {
      type: String,
