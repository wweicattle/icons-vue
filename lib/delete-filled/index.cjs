...
var delete_filled_exports = {};
__export(delete_filled_exports, {
  default: () => delete_filled_default
});
module.exports = __toCommonJS(delete_filled_exports);
...
var delete_filled_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
